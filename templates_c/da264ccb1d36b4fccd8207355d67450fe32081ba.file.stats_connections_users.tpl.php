<?php /* Smarty version Smarty-3.1.14, created on 2014-02-13 19:27:49
         compiled from ".\templates\administration_magasin\statistiques\stats_connections_users\stats_connections_users.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    array (
      0 => '.\\templates\\administration_magasin\\statistiques\\stats_connections_users\\stats_connections_users.tpl',
      1 => 1392319616,
      2 => 'file',
    ),
  ),
...
function RefreshXMLConnectionsUsers ()
{
    var responseText = $.ajax({
            type    : "POST",
            url     : "ajax/infos/administration_magasin/GetXMLConnectionsUsers.php",
            async   : false,
            data    : "",
...
<div id="Content">
    ...
    <div style="clear: both;">&nbsp;</div>
    <div class="btn_precedent"style="float: right;" onclick="javascript:document.location.href='administration_magasin.php?sub=stats_connections_users';"></div>
</div>
