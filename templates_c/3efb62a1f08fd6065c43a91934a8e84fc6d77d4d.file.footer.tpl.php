...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2397352eba7b19b89e7-98980603',
  'function' => 
  array (
  ),
  'variables' => 
...
function UpdateTSorter ()
{
	...
	$(".tablesorter").each (function ()
	{
		...
		{
			$(this).dataTable ({
				"iDisplayLength": <?php echo (($tmp = @$_smarty_tpl->tpl_vars['parametrage']->value['nb_rows_in_table'])===null||$tmp==='' ? 100 : $tmp);?>
, 
				"oLanguage": {
...
$(document).ready (function ()
{
	...
	<?php if (!isset($_smarty_tpl->tpl_vars['Globals']->value['ActivateInfoBulles'])||$_smarty_tpl->tpl_vars['Globals']->value['ActivateInfoBulles']){?>
		var theme = "light";
