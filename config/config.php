<?php
	...
	On va utiliser la valeur ProductionEnvironment pour d�terminer si on
	est bien dans un environnement propice � l'utilisation des r�pertoires
	sp�cifiques.
	
	**************************************************************** */
    define('DB_HOST', 'localhost');
    define('DB_NAME', 'quincaillerie.db_dev');
