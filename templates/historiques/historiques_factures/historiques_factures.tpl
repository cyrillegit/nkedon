...
<div id="Content">
    <div class="bloc_title">
        ...
        <div style="width: 990px; height: 51px; border-bottom: 1px solid #fff; float:left;">
            ...
            <div class="t_titre">
                <div class="title"><strong>Historiques </strong> <strong style="color:black;">des factures par années</strong></div>
            </div>
        </div>
    </div>
    <div class="intro">Dans cet écran, vous avez la possibilité de visualiser des factures classées par année.<br/><br/></div>
    ...
    <div class="bg_filter" style="line-height:50px;">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                Les différentes années de factures.
                </td>
