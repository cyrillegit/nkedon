...
{
	$infos = $db->getInfoFournisseur ( $id_fournisseur );
}
?>
...
<div class="content">
    ...
    <div style="width: 100%;">
        <form name="form_popup" id="form_popup" method="post">
                	...
                	<td>
                		<table>
                			<tr>
                				...
                				<td><input type="text" name="nom_fournisseur" id="nom_fournisseur" value="<?php if( $infos ) { echo $infos ["nom_fournisseur"]; } ?>"/></td>
                			</tr>
                			<tr>
                				<td>Adresse du fournisseur :<span class="champObligatoire">*</span></td>
                				<td><input type="text" name="adresse_fournisseur" id="adresse_fournisseur" value="<?php if( $infos ) { echo $infos ["adresse_fournisseur"]; } ?>"/></td>
                			</tr>
                			<tr>
                				<td>Numéro de téléphone :<span class="champObligatoire">*</span></td>
                				<td><input type="text" name="telephone_fournisseur" id="telephone_fournisseur" value="<?php if( $infos ) { echo $infos ["telephone_fournisseur"]; } ?>"/></td>
                			</tr>
                		</table>
                	</td>
                	<!--PARTIE DROITE-->
	        ...
	        <input type="hidden" id="id_fournisseur" name="id_fournisseur" value="<?=$id_fournisseur;?>" />
        </form>
	</div>
