...
<div class="content">
	<div class="TitrePopup">Faire l'inventaire <strong style="color:#1c9bd3">d'un produit</strong></div>
                	...
                	<td>
                		<table>
                			...
                			<tr>
                				...
                				<td><input type="text" name="stock_physique" id="stock_physique" value=""/></td>
                			</tr>
                		</table>
                	</td>
                	<!--PARTIE DROITE-->
