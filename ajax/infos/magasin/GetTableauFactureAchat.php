<?php
/**
	Fichier GetTableauFactureAchat.php
	-----------------------------------
...
$factures = $db->getInfosFactureAchatById( $id_facture );
                        ...
                        <tr>
                            <td>
                                <tr class="blocInfoBis">
                                    ...
                                    <td class="blocTitreId">Nom fournisseur : <br/><strong><?php  echo $factures[0]["nom_fournisseur"]; ?></strong></td>
                                    <td class="blocTitreId">Date facture : <br/><strong><?php  echo SQLDateToFrenchDate( $factures[0]["date_facture"] ); ?></strong></td>
                                    <td class="blocTitreId">Enregistrée le : <br/><strong><?php  echo SQLDateTimeToFrenchDateTime( $factures[0]["date_insertion_facture"] ); ?></strong></td>
