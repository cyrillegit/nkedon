            ...
            foreach( $datas as &$obj )
            {
                ...
                <tr>
                    ...
                    <?php if($_SESSION ["infoUser"]["idt_types_users"] == 1 || $_SESSION ["infoUser"]["idt_types_users"] == 2){?>
                        <img src="css/images/page_white_edit.png" title="modifier" border="0" class="edit_compte_utilisateur" style="cursor: pointer;" id_compte="<?=$obj ["idt_users"]; ?>" />
                        <a class="delete_link" title="supprimer" url="delete.php?target=compte_utilisateur&id=<?=$obj["idt_users"]; ?>"><img src="css/images/supprimer.png" border="0" /></a>
                    <?php }?>
                    </td>
                </tr>
                <?php
