...
$datas = $db->getAllNumberFacturesFournisseurCurrent();
...
$writer->startElement('chart');   
   ...
   $writer->writeAttribute('subcaption', 'Nombre de factures par fournisseur'); 
   $writer->writeAttribute('xAxisName', 'Fournisseurs');
   $writer->writeAttribute('yAxisName', 'Nombre de factures'); 
