...
$datasVentes = $db->getAllProduitsOperationsJournalLastYear();
...
$writer->openURI( 'data_stats_operations_journal.xml');
$writer->startDocument('1.0','UTF-8');
$writer->setIndent(4);
$writer->startElement('chart');
$writer->writeAttribute('caption', 'Evolution des opérations de ventes');
...
<script type="text/javascript">
    ...
    myChart.setXMLUrl("ajax/infos/statistiques/data_stats_operations_journal.xml");
