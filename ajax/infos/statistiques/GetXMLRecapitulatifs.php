...
$datas = $db->getInfosInventairesUneAnnee ();
$datas = array_reverse( $datas, true );

$writer = new XMLWriter();
$writer->openURI( 'data_stats_recapitulatifs.xml');
...
$writer->writeAttribute('numvdivlines', '0');
...
//
$writer->startElement('dataset');
$writer->writeAttribute('seriesName', 'Fonds');
...
{
    $writer->startElement('set');
    $writer->writeAttribute('value', $data["fonds"] );
    $writer->endElement();
}
$writer->endElement();
//
...
<script type="text/javascript">
    ...
    myChart.setXMLUrl("ajax/infos/statistiques/data_stats_recapitulatifs.xml");
