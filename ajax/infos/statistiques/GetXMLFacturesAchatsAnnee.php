...
$datasAchats = $db->getAllProduitsAchetesLastYear();
foreach ( $datasAchats as $data )
{
    $date =  getMonthYearFromDatetime( $data["date_facture"] );
...
$writer->openURI( 'data_stats_factures_achats_annee.xml');
...
<div id="chartContainerAchats"></div>
    <script type="text/javascript">
        ...
        myChart.setXMLUrl("ajax/infos/statistiques/data_stats_factures_achats_annee.xml");
